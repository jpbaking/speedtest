...
In non-Docker deployments, the contents of this directory must be copied so
`styling/`, `javascript/`, `images/`, and `fonts/` sit next to the root HTML
files.
...
- `index.html` shows how the frontend is wired up.
